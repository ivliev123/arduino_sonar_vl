...
#define urmAccount 3   // Init the account of the URM04 sensor
...
void runUrm4(int num){                 // You could adjust the sensor measuring rate by changing the managerTimer value
